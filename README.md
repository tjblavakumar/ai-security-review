...
- `POST /api/submissions/{id}/upload-document` — Upload project document (PDF/TXT)
...
### Document Upload & Auto-Population
**NEW:** Users can now upload project documents (PDF or TXT files) when creating a submission:
- Upload optional project documentation on the first page
- System extracts text content automatically
- AI suggestions use document content for better context
- Supports PDF (via PyPDF2) and plain text files
- File size limit: 10MB
- Document content is included in all AI suggestion prompts
...
- **Uses uploaded document content for accurate suggestions**
