...
class Submission(Base):
    ...
    uploaded_document_path: Mapped[str | None] = mapped_column(String(500), nullable=True)
    uploaded_document_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    uploaded_document_content: Mapped[str | None] = mapped_column(Text, nullable=True)  # Extracted text content
